...
/**
 * TUserTBaseClientId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class TUserTBaseClientId implements java.io.Serializable {
	...
	/** default constructor */
	public TUserTBaseClientId() {
	}

	/** full constructor */
	public TUserTBaseClientId(Long userId, String clientId) {
		this.userId = userId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TUserTBaseClientId))
			return false;
		TUserTBaseClientId castOther = (TUserTBaseClientId) other;
